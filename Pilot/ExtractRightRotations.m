...
folderPath = 'N:\VLOpt\Pilot\S211381\AR\';
...
for k = 1:length(fileList)
    ...
    FinalTable = TempFile(filtered_indexes(6,1):filtered_indexes(7,1), :);
    
    % Define the output file name
    [~, name, ~] = fileparts(FileName);
    txtFileName = fullfile(folderPath, [name, '_RightBendShortened.txt']);
